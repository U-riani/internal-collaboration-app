  ...
  return (
    <>
      ...
      {query.isLoading || groups.isLoading ? (
        ...
        <div className="task-list-card card max-h-[calc(100vh-377px)] md:max-h-[calc(100vh-10.74rem)] overflow-auto">
          <div className=" ">
            ...
            {groupSections.map((group) => {
              ...
              return (
                <section key={group.id}>
                  <div className="task-group-header sticky top-0 md:top-10 z-4 flex min-w-[940px] items-center gap-2 border-t border-slate-200 bg-slate-100 px-4 py-2.5">
                    <button
                      type="button"
